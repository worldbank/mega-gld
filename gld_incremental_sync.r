...
# Table names
METADATA_TABLE <- paste0(TABLE_QULIFIER, ".test_ingestion_metadata")
HARMONIZED_CONFIDENTIAL <- paste0(TABLE_QULIFIER, ".test_GLD_HARMONIZED_ALL")
HARMONIZED_OFFICIAL <- paste0(TABLE_QULIFIER, ".test_GLD_HARMONIZED_OUO")
